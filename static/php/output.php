	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		//get values from the form in summary.html
		...
		$totalMaintenanceCostConv = 0;
		$totalSewageCostConv = 0;
		$totalResurfacingCostConv = 0;
		$totalReplacementCostConv = 0;
		$replacementCostNew = 0;
		$resurfacingCostNew = 0;
		$totalTrafficDelayCostNew = 0;
		$totalcrashRiskCostNew = 0;
		$totalVehicleOperationCostNew = 0;
		$totalSewageCostNew = 0;
		$totalMaintenanceCostNew = 0;
		$totalResurfacingCostNew = 0;
		$totalReplacementCostNew = 0;
		...
		//array to hold agency and user cost for every 5 years
